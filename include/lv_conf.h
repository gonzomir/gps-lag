...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lvgl_rethinksans_bold_24) LV_FONT_DECLARE(lvgl_rethinksans_bold_200)

/*Always set a default font*/
#define LV_FONT_DEFAULT &lvgl_rethinksans_bold_24
